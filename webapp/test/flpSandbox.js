		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Retail Portal",
									"targetURL": "#retailportalretailportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"retailportalretailportal-display": {
								"semanticObject": "retailportalretailportal",
								"action": "display",
								"description": "Retail Portal Fiori application.",
								"title": "Retail Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=retailportal.retailportal",
									"url": sap.ui.require.toUrl("retailportal/retailportal")
								}
							}
						}
					}
